...
LINTER_COMMANDS_ARRAY['TERRAFORM_TFSEC']="tfsec --config-file ${TERRAFORM_LINTER_RULES}/config.yml --custom-check-dir=${TERRAFORM_LINTER_RULES} ${LINTER_OPTS[TERRAFORM_TFSEC]} "
