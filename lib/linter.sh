...
# shellcheck disable=SC2034  # Variable is referenced indirectly
CLOUDFORMATION_CFN_NAG_FILE_NAME=".cfnnag"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
# shellcheck disable=SC2034  # Variable is referenced indirectly
PYTHON_BANDIT_FILE_NAME="${PYTHON_BANDIT_CONFIG_FILE:-.bandit.yml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
# shellcheck disable=SC2034  # Variable is referenced indirectly
SECURITY_TOOLS=('CLOUDFORMATION_CFN_NAG' 'DOCKERFILE_HADOLINT' 'GITLEAKS' 'PYTHON_BANDIT' 'TERRAFORM_TERRASCAN' 'DEPS_CHECKER')
...
LINTER_COMMANDS_ARRAY['CLOUDFORMATION_CFN_NAG']="cfn_nag_scan --ignore-fatal --blacklist-path=${CLOUDFORMATION_CFN_NAG_LINTER_RULES} ${LINTER_OPTS[CLOUDFORMATION_CFN_NAG]}"
